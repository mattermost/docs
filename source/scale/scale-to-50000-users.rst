...
This page describes the Mattermost reference architecture designed for the load of up to 50000 concurrent users. Unsure which reference architecture to use? See the `scaling for enterprise </scale/scaling-for-enterprise.html>`__ documentation for details.
...
+========================+==========+==================+================+==================+
| Mattermost Application | 8        | 16               | 5              | c6i.2xlarge      |
+------------------------+----------+------------------+----------------+------------------+
