...
This page describes the Mattermost reference architecture designed for the load of up to 50000 concurrent users. Unsure which reference architecture to use? See the `scaling for enterprise </scale/scaling-for-enterprise.rst>`__ documentation for details.
...
+========================+==========+==================+================+==================+====================+==================+
| Mattermost Application | 8        | 16               | 5              | c6i.xlarge       |                    |                  |
+------------------------+----------+------------------+----------------+------------------+--------------------+------------------+
| RDS Writer             | 8        | 64               | 1              | db.r6g.xlarge    |                    |                  |
+------------------------+----------+------------------+----------------+------------------+--------------------+------------------+
| RDS Reader             | 8        | 64               | 4              | db.r6g.xlarge    |                    |                  |
+------------------------+----------+------------------+----------------+------------------+--------------------+------------------+
