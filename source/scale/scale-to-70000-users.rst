...
This page describes the Mattermost reference architecture designed for the load of up to 70000 concurrent users. Unsure which reference architecture to use? See the `scaling for enterprise </scale/scaling-for-enterprise.html>`__ documentation for details.
...
+========================+==========+==================+================+==================+
| Mattermost Application | 16       | 32               | 4              | c6i.4xlarge      |
+------------------------+----------+------------------+----------------+------------------+
