...
Set up performance monitoring for Mattermost. See our :doc:`Performance Monitoring </scale/deploy-prometheus-grafana-for-performance-monitoring>` documentation to learn more.
...
If you want more alerts, you can set them up on any of the Grafana charts you'd like. We recommend reviewing custom metrics listed on our :doc:`Performance Monitoring feature documentation </scale/performance-monitoring-metrics>`.
