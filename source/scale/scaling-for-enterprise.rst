...
- See `install guides for step-by-step configuration instructions for single machine setup <https://docs.mattermost.com/install/desktop-app-install.html#desktop-application-install-guides>`__.
...
- See `install guides for step-by-step configuration instructions for multi-machine setup <https://docs.mattermost.com/install/desktop-app-install.html#desktop-application-install-guides>`__.
- See `hardware and software requirements for hardware sizing <https://docs.mattermost.com/install/software-hardware-requirements.html>`__.
