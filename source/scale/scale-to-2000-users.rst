...
+------------------------+-----------+----------------+-------------------+-------------------+
| RDS Writer             | 1         | 2/16           | db.r7g.large      | D2as v5           |
+------------------------+-----------+----------------+-------------------+-------------------+
| RDS Reader             | 1         | 2/16           | db.r7g.large      | D2as v5           |
+------------------------+-----------+----------------+-------------------+-------------------+
| Elasticsearch Node     | 2         | 4/32           | r6g.xlarge.search | Standard E4as v5  |
+------------------------+-----------+----------------+-------------------+-------------------+
| Proxy                  | 1         | 16/64          | m7i.4xlarge       | D16s v5           |
+------------------------+-----------+----------------+-------------------+-------------------+
