...
**Mattermost Team Edition** is an open source, self-hosted application offering "All your team communication in one place, easy-to-use, searchable, and accessible anywhere". New compiled releases available monthly under an MIT license from `mattermost.org/download`_.
