...
.. toctree::
   ...
   /product-overview/product-overview-index.rst
   /use-case-guide/use-cases-index.rst
   /deployment-guide/deployment-guide-index.rst
   /administration-guide/administration-guide-index.rst
   /security-guide/security-guide-index.rst
   /end-user-guide/end-user-guide-index.rst
   /integrations-guide/integrations-guide-index.rst
   /get-help/get-help-index.rst
...
* :doc:`Messaging Collaboration </end-user-guide/messaging-collaboration>` - Stay connected with your team via 1:1 and group messages, voice calls, and screensharing.
* :doc:`Workflow Automation </end-user-guide/workflow-automation>` - Build and configure repeatable processes with workflow automation to achieve specific and predictable outcomes.
...
* :doc:`Project and Task Management </end-user-guide/project-task-management>` - Coordinate your operational work using Mattermost Boards with Kanban-style planning.
* :doc:`AI Agents </end-user-guide/agents>` - Use AI agents to help you make decisions, find information, and automate tasks in Mattermost.
* :doc:`Customize Your Preferences </end-user-guide/preferences>` - Match the way you work by adjusting your notification settings, changing your theme, or updating your profile settings.
...
* :doc:`Product Overview </product-overview/product-overview-index>` - Learn about Mattermost capabilities and features.
* :doc:`Use Case Guide </use-case-guide/use-cases-index>` - Learn about Mattermost use cases for mission critical operations.
* :doc:`Deployment Guide </deployment-guide/deployment-guide-index>` - Learn about the Mattermost deployment process, including system requirements, installation, and configuration.
* :doc:`Administration Guide </administration-guide/administration-guide-index>` - Learn about the Mattermost administration process, including user management, security settings, and system maintenance.
* :doc:`Security Guide </security-guide/security-guide-index>` - Mattermost can meet the strictest security requirements and provides the highest level of control over user data.
* :doc:`End User Guide </end-user-guide/end-user-guide-index>` - Learn how to use Mattermost to collaborate with your teammates.
* :doc:`Integrations Guide </integrations-guide/integrations-guide-index>` - Learn how Mattermost is extensible by design and supports a rich ecosystem of third-party apps and integrations.
* :doc:`Training and Support </get-help/get-help-index>` - Learn about Mattermost training and support options.
