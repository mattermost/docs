...
**Mattermost Enterprise Edition** is a pre-released commercial version of Mattermost offering additional features for large organizations including enterprise authentication to systems like Active Directory, compliance and auditing support, and sophisticated configurations for high availabilty services. More information is available by `contacting Mattermost, Inc.`_
