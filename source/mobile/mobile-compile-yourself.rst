...
1. Compile your own iOS and Android mobile applications from the `open source repository <https://github.com/mattermost/mattermost-mobile>`_. Use `this guide <https://docs.mattermost.com/developer/mobile-developer-setup.html#mobile-developer-machine-setup`_ to help set up your environment and build the apps.
