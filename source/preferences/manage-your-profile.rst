...
|                     | .. note::                                                                                       |
|                     |                                                                                                 |
|                     |   If your name is configured through a login provider, you'll need to manage name changes       |
...
|                     |     in posted messages.                                                                         |
|                     |   - If your username is configured through a login provider, you'll need to manage user name    |
...
|                     |   Trigger Mentions** notifications list as a `Notifications                                     |
|                     |   </preferences/manage-your-notifications.html>`__ preference.                                  |
+---------------------+-------------------------------------------------------------------------------------------------+
...
|                     | .. note::                                                                                       |
|                     |                                                                                                 |
|                     |   If your position is configured through a login provider, you'll need to manage position       |
...
|                     | .. note::                                                                                       |
|                     |                                                                                                 |
|                     |   If your email is configured through an SSO service, you can't edit your email address, and    |
|                     |   you'll receive email notifications to the email you used to sign up to your SSO service.      |
...
|                     | .. tip::                                                                                        |
|                     |                                                                                                 |
|                     |   For best results, choose an image that's at least 128 x 128 pixels in size.                   |
|                     |   Supported image formats include: BMP, JPG, JPEG, and PNG. GIF isn't supported.                |
+---------------------+-------------------------------------------------------------------------------------------------+