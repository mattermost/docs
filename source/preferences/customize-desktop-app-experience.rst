...
.. tabs::
    ...
    .. tab:: Mac
        ...
        `Install the Mattermost desktop app </collaborate/install-desktop-app.html#install-and-update-the-mattermost-desktop-app>`__ to access additional Desktop App customization settings. Select **Mattermost > Preferences** from the menu bar.
