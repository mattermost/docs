...
3. Type in the Token generated by Google Authenticator, then select **Save**.
...
6. In Mattermost, type the token generated by Google Authenticator, then select **Save**.
