...
**Not getting a desktop notification?** See our `FAQ to view the desktop notification flow chart <xxxxxx>`_ and see what other factors influence if a notification should be triggered.
...
**Not getting an email notification?** See our `FAQ to view the email notification flow chart <xxxxxx>`_ and see what other factors influence if a notification should be triggered.
...
**Not getting a push notification?** See our `FAQ to view the email notification flow chart <xxxxxx>`_ and see what other factors influence if a notification should be triggered.   
