...
- Archived channels are searched as long as you are a member of that channel. To remove archive channels from your search results you can leave the channel. If you are unable to see archived messages in your search results, ask your system administrator if "Allow users to view archived channels" has been disabled under **System Console > Uers and Teams**.
