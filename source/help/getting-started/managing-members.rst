...
Direct invites are invitation emails sent from your team's server directly to the invited person's email address. A link within the invitation directs them to an account creation page. Invitation links sent by email expire after 24 hours or if the System Admin regenerates the `Email Invite Salt <https://docs.mattermost.com/administration/config-settings.html#email-invite-salt>`_.
