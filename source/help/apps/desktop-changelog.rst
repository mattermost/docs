...
- **v4.5.2, released 2020-07-20**
 - Fixed an issue on Linux app started as a blank screen if both “Show icon in the notification area" and "Start app on login" were enabled. `MM-26832 <https://mattermost.atlassian.net/browse/MM-26832>`_
