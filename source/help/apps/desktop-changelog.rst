...
- **v4.4.2, release day TBD**
 - Fixed an issue on Windows where no notification was received if the app was closed on a channel where the message was posted. `MM-23215 <https://mattermost.atlassian.net/browse/MM-23215>`_
