...
Known Issues
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
- Segmentation Fault crashes might be be experienced in some desktop clients. This is an upstream bug and a recommended workaround is to disable the system tray icon in the Desktop settings.
