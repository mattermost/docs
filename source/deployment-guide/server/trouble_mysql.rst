...
.. note::
  ...
  - See the :ref:`database configuration settings <administration-guide/getting-started/environment-configuration-settings:database>` documentation for details on configuration options specific to MySQL databases.
