...
From Mattermost v8.0, :ref:`PostgreSQL <deployment-guide/software-hardware-requirements:database software>` is our database of choice for Mattermost to enhance the platform’s performance and capabilities.
