...
.. tab:: CentOS/RHEL
  ...
  1. Download the latest version of the Mattermost desktop app for 64-bit systems: `mattermost-desktop-6.2.3-linux-x86_64.rpm <https://releases.mattermost.com/desktop/6.2.3/mattermost-desktop-6.2.3-linux-x86_64.rpm>`_

  2. At the command line, execute the following command:

    .. code-block:: sh

      sudo rpm -i mattermost-desktop-6.2.3-linux-x86_64.rpm
  ...
  To manually update the desktop app, run the following command:
    ...
    .. code-block:: sh
      ...
      sudo rpm -u mattermost-desktop-6.2.3-linux-x86_64.rpm
...
.. tab:: Flatpak
  ...
  3. Install the Flatpak package:
    ...
    .. code-block:: sh
     ...
     Replace ``{VERSION}`` with the version number (e.g., ``6.2.3``) and ``{ARCH}`` with your architecture (``x86_64`` or ``aarch64``).
...
.. tab:: Generic Linux
  ...
  1. Download the latest version of the Mattermost desktop app for 64-bit systems: `mattermost-desktop-6.2.3-linux-x64.tar.gz <https://releases.mattermost.com/desktop/6.2.3/mattermost-desktop-6.2.3-linux-x64.tar.gz>`_
