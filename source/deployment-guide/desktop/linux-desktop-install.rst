...
.. tab:: CentOS/RHEL
  ...
  1. Download the latest version of the Mattermost desktop app for 64-bit systems: `mattermost-desktop-6.0.1-linux-x86_64.rpm <https://releases.mattermost.com/desktop/6.0.1/mattermost-desktop-6.0.1-linux-x86_64.rpm>`_

  2. At the command line, execute the following command:
    
    .. code-block:: sh

      sudo rpm -i mattermost-desktop-6.0.1-linux-x86_64.rpm
  ...
  To manually update the desktop app, run the following command:
    ...
    .. code-block:: sh
      ...
      sudo rpm -u mattermost-desktop-6.0.1-linux-x86_64.rpm
...
.. tab:: Generic Linux
  ...
  1. Download the latest version of the Mattermost desktop app for 64-bit systems: `mattermost-desktop-6.0.1-linux-x64.tar.gz <https://releases.mattermost.com/desktop/6.0.1/mattermost-desktop-6.0.1-linux-x64.tar.gz>`_
