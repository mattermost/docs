...
.. note::
    Using this feature requires a `custom build of the Mattermost desktop app </deployment-guide/desktop/distribute-a-custom-desktop-app>`.
...
In addition to customizing the Mattermost Desktop App, the :ref:`Managed Resource Paths <administration-guide/getting-started/environment-configuration-settings:managed resource paths>` setting on the Mattermost server must be configured.
