...
3. Navigate to the release page for `version v6.2.2 <https://github.com/mattermost/desktop/releases/latest>`__ and download the appropriate installer for your version of Windows (32-bit vs. 64-bit).

4. Download the `source.zip <https://github.com/mattermost/desktop/archive/v6.2.2.zip>`__ file as well to extract group policy files.
...
.. note::
   - Replace ``<version>`` with the actual version number (e.g., ``v6.2.2``).
