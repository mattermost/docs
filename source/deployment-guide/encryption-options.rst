...
Starting from Mattermost v10.11, :ref:`gossip encryption <administration-guide/configure/environment-configuration-settings:enable gossip encryption>` is enabled by default for new deployments while existing deployments maintain their current configuration.
