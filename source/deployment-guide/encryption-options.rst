...
Connections to Active Directory/LDAP can :ref:`optionally be secured with TLS or stunnel <administration-guide/configuration-reference/authentication-configuration-settings:ad/ldap port>`.
