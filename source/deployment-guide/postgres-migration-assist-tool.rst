...
If your config was stored in the database, update ``MM_CONFIG`` accordingly. See the :ref:`environment configuration settings <administration-guide/getting-started/environment-configuration-settings:database>` documentation for details.
