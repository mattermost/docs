...
.. note::
   Before pasting the webhook URL in JIRA, make sure to replace ``teamname`` and ``channelname`` with the Mattermost team URL and channel URL you want the JIRA events to post to. The values should be in lower case.
