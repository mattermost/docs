...
The **API Key** and **API Secret** are generated by Zoom and are used to create meetings and pull user data. To generate an **API Key** and **API Secret** requires a Pro, Business, Education, or API Zoom plan.
