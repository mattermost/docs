...
Make sure you are running on a supported version of :doc:`Mattermost </lifecycle/mattermost-server-releases/>` to benefit from the most up-to-date functionality and fixes.
