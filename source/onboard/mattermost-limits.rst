...
- Unlimited plugins can be installed but only 5 can be enabled at one time. Bundled plugins such as Boards, Calls, and Playbooks do not count toward this limit.
