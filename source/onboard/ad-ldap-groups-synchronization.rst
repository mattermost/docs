...
You can do this by setting the team or channel management to synced groups instead defaulting a group to a team or channel. See `this documentation </onboard/ad-ldap-groups-synchronization.html#synchronizing-teams-and-channels>`_ to learn more.
