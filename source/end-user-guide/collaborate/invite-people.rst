...
.. note::
  ...
  - Your system admin must :ref:`enable email invitations <administration-guide/configuration-reference/authentication-configuration-settings:enable email invitations>` and configure :ref:`email <administration-guide/configuration-reference/environment-configuration-settings:smtp>` for Mattermost to send email-based invitations.
