...
.. note::
    ...
    - Any member of an existing group message, except :doc:`guests </administration-guide/onboard/guest-accounts>`, can convert that group message to a private channel.
...
.. tab:: Mobile
  ...
  .. image:: ../../images/mobile-select-a-group-message.jpg
      :alt: Select a group that you want to convert.
      :scale: 30

  2. Tap the **More** |more-icon-vertical| icon located in the top right corner of the app.

  .. image:: ../../images/mobile-select-more-options-for-a-group.jpg
      :alt: Tap on More options to access available options for the group.
      :scale: 30

  3. Tap **View info**.

  .. image:: ../../images/mobile-select-view-info-for-a-group.jpg
      :alt: Tap on View info to see the basic group info.
      :scale: 30

  4. Tap **Convert to a Private Channel**.

  .. image:: ../../images/mobile-convert-group-to-private-channel.jpg
      :alt: Tap on Convert to a Private Channel to convert the group.
      :scale: 30

  5. Enter the private channel name.

  .. image:: ../../images/mobile-provide-private-channel-name-for-the-group.jpg
      :alt: Type a name for the Private channel.
      :scale: 30
