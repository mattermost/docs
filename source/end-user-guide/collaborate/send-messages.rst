...
.. tab:: Mobile
  ...
  Users can receive burn-on-read messages on mobile but can't send them. From Mattermost mobile v2.38.0, the post-actions available for burn-on-read messages on mobile match those in the web and desktop app.
