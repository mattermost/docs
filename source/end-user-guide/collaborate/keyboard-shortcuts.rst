...
.. toctree::
  ...
  Run slash commands </end-user-guide/collaborate/run-slash-commands>
  Built-in-slash-commands </end-user-guide/collaborate/built-in-slash-commands>
...
.. tip::
  ...
  - More keyboard shortcuts are available. See the :doc:`team keyboard shortcuts </end-user-guide/collaborate/team-keyboard-shortcuts>` and :ref:`text style <end-user-guide/collaborate/format-messages:text style>` documentation for details.
...
The following keyboard shortcuts for channels are supported in all :ref:`supported browsers <deployment-guide/software-hardware-requirements:software requirements>` and in the Mattermost desktop app.
...
The following keyboard shortcuts are supported in all :ref:`supported browsers <deployment-guide/software-hardware-requirements:software requirements>` and in the Mattermost desktop app.
...
The following keyboard shortcuts work in all :ref:`supported browsers <deployment-guide/software-hardware-requirements:software requirements>` and in the Mattermost desktop app.
...
The following keyboard shortcuts are supported in all :ref:`supported browsers <deployment-guide/software-hardware-requirements:software requirements>` and in the Mattermost desktop app when :doc:`calls </end-user-guide/collaborate/make-calls>` are enabled.
...
The following display keyboard shortcuts work in all :ref:`supported browsers <deployment-guide/software-hardware-requirements:software requirements>` and in the Mattermost desktop app.
