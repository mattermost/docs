...
.. tip::
  ...
  When you join channels, depending on the :doc:`channel actions configured </end-user-guide/collaborate/create-channels>`, you may see a welcome message, and channels may be added to :doc:`a category in your channel sidebar </end-user-guide/preferences/customize-your-channel-sidebar>` automatically. 
...
- :doc:`Create channels </end-user-guide/collaborate/create-channels>`
- :doc:`Browse channels </end-user-guide/collaborate/browse-channels>`
- :doc:`Customize your channel sidebar </end-user-guide/preferences/customize-your-channel-sidebar>`
...
.. note::
  ...
  All users are added to the **Town Square** channel automatically. This means that users can't :ref:`archive <end-user-guide/collaborate/archive-unarchive-channels:archive a channel>`, :ref:`unarchive <end-user-guide/collaborate/archive-unarchive-channels:unarchive a channel>`, or leave the **Town Square** channel. However, :doc:`guests </administration-guide/onboard/guest-accounts>` who are manually invited to **Town Square** can leave the channel.
