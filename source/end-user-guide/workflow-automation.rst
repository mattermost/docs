...
.. tab:: Mobile
   ...
   From Mattermost v11 and mobile app v2.23.0, mobile users can access playbooks from the mobile app to :ref:`interact with playbook tasks <end-user-guide/workflow-automation/work-with-tasks:interact with playbook tasks>` and :ref:`update tasks <end-user-guide/workflow-automation/work-with-tasks:update tasks>`.
