...
Select **Custom Theme**, then expand the :ref:`Sidebar Styles <end-user-guide/preferences/customize-your-theme:sidebar styles>`, :ref:`Center Channel Styles <end-user-guide/preferences/customize-your-theme:center channel styles>`, and :ref:`Link and Button Styles <end-user-guide/preferences/customize-your-theme:link and button styles>` options to customize individual interface colors, such as backgrounds, links, text, and borders. 
