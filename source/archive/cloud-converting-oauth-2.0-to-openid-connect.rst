...
For details on configuring Mattermost to use a service provider as a Single Sign-on (SSO) service for team creation, account creation, and user login using OpenID Connect, refer to the following documentation:
