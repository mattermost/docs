...
3. To create an access token with a non-admin account, you must first give it the appropriate permissions. Go to **System Console > User Management > Users**, search for the user account, and select **Manage Roles** from the dropdown.
...
7. Go to **Account Settings > Security > Personal Access Tokens** and select **Create New Token**.
