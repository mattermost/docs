...
.. important::
   ...
   Support for Mattermost Server v5.37 `Extended Support Release <https://docs.mattermost.com/upgrade/extended-support-release.html>`_ has come to the end of its life cycle on April 15, 2022. Upgrading to Mattermost Server v6.3 `Extended Support Release <https://docs.mattermost.com/upgrade/extended-support-release.html>`_ or later is required.
...
Mattermost Enterprise Edition v7.0.0 - `View Changelog <https://docs.mattermost.com/install/self-managed-changelog.html#release-v7-0-major-release>`__ - `Download <https://releases.mattermost.com/7.0.0/mattermost-7.0.0-linux-amd64.tar.gz?src=arc>`__
  - ``https://releases.mattermost.com/7.0.0/mattermost-7.0.0-linux-amd64.tar.gz``
  - SHA-256 Checksum: ``3b66c9b23d988de6917ea3eb7a18309fc6cd1da630a9cadc53586d098bab3e5c``
  - GPG Signature: https://releases.mattermost.com/7.0.0/mattermost-7.0.0-linux-amd64.tar.gz.sig
Mattermost Enterprise Edition v6.7.1 - `View Changelog <https://docs.mattermost.com/install/self-managed-changelog.html#release-v6-7-feature-release>`__ - `Download <https://releases.mattermost.com/6.7.1/mattermost-6.7.1-linux-amd64.tar.gz?src=arc>`__
  - ``https://releases.mattermost.com/6.7.1/mattermost-6.7.1-linux-amd64.tar.gz``
  - SHA-256 Checksum: ``91336faa82236a0dc92b38b6f43c5348953be6451b070a0dde4b7869344d8820``
  - GPG Signature: https://releases.mattermost.com/6.7.1/mattermost-6.7.1-linux-amd64.tar.gz.sig
...
Mattermost Enterprise Edition v6.3.9 *Extended Support Release (ESR)* - `View Changelog <https://docs.mattermost.com/install/self-managed-changelog.html#release-v6-3-extended-support-release>`__ - `Download <https://releases.mattermost.com/6.3.9/mattermost-6.3.9-linux-amd64.tar.gz?src=arc>`__
  - ``https://releases.mattermost.com/6.3.9/mattermost-6.3.9-linux-amd64.tar.gz``
  - SHA-256 Checksum: ``7785ebca2ad4d0ad75d7c774dd56bf74bf62a3091e698fc6d6ea52cfd5d40a63``
  - GPG Signature: https://releases.mattermost.com/6.3.9/mattermost-6.3.9-linux-amd64.tar.gz.sig
...
Mattermost Enterprise Edition v5.37.9 *Extended Support Release (ESR)* - `View Changelog <https://docs.mattermost.com/install/self-managed-changelog.html#release-v5-37-extended-support-release>`__ - `Download <https://releases.mattermost.com/5.37.9/mattermost-5.37.9-linux-amd64.tar.gz?src=arc>`__
  - ``https://releases.mattermost.com/5.37.9/mattermost-5.37.9-linux-amd64.tar.gz``
  - SHA-256 Checksum: ``7756ef0e439a19d81edb04c9b662d50bb03e5c3e7b4fc45da4e4adb0eea71d5c``
  - GPG Signature: https://releases.mattermost.com/5.37.9/mattermost-5.37.9-linux-amd64.tar.gz.sig
...
Mattermost Team Edition v7.0.0 - `View Changelog <https://docs.mattermost.com/install/self-managed-changelog.html#release-v7-0-major-release>`__ - `Download <https://releases.mattermost.com/7.0.0/mattermost-team-7.0.0-linux-amd64.tar.gz?src=arc>`__
  - ``https://releases.mattermost.com/7.0.0/mattermost-team-7.0.0-linux-amd64.tar.gz``
  - SHA-256 Checksum: ``8a303cdaf0edd28f318d5fe504238da6aa2afbe4fce27cfee8370aac3b46e02a``
  - GPG Signature: https://releases.mattermost.com/7.0.0/mattermost-team-7.0.0-linux-amd64.tar.gz.sig
Mattermost Team Edition v6.7.1 - `View Changelog <https://docs.mattermost.com/install/self-managed-changelog.html#release-v6-7-feature-release>`__ - `Download <https://releases.mattermost.com/6.7.1/mattermost-team-6.7.1-linux-amd64.tar.gz?src=arc>`__
  - ``https://releases.mattermost.com/6.7.1/mattermost-team-6.7.1-linux-amd64.tar.gz``
  - SHA-256 Checksum: ``938604165c1c2238d9f04045d30dde0e6d05065df6ac22faacec0880785a236f``
  - GPG Signature: https://releases.mattermost.com/6.7.1/mattermost-team-6.7.1-linux-amd64.tar.gz.sig
...
Mattermost Team Edition v6.3.9 *Extended Support Release (ESR)* - `View Changelog <https://docs.mattermost.com/install/self-managed-changelog.html#release-v6-3-extended-support-release>`__ - `Download <https://releases.mattermost.com/6.3.9/mattermost-team-6.3.9-linux-amd64.tar.gz?src=arc>`__
  - ``https://releases.mattermost.com/6.3.9/mattermost-team-6.3.9-linux-amd64.tar.gz``
  - SHA-256 Checksum: ``026d0e59b28a3c1fb29b78240f5d1ad80942c7bc35fcac62631c7d18f4a2f0ef``
  - GPG Signature: https://releases.mattermost.com/6.3.9/mattermost-team-6.3.9-linux-amd64.tar.gz.sig
...
Mattermost Team Edition v5.37.9 *Extended Support Release (ESR)* - `View Changelog <https://docs.mattermost.com/install/self-managed-changelog.html#release-v5-37-extended-support-release>`__ - `Download <https://releases.mattermost.com/5.37.9/mattermost-team-5.37.9-linux-amd64.tar.gz?src=arc>`__
  - ``https://releases.mattermost.com/5.37.9/mattermost-team-5.37.9-linux-amd64.tar.gz``
  - SHA-256 Checksum: ``9a69fccaa6045cb37abbb96edfcc154dde270cb46bb323dc7ed033f03fa14d7d``
  - GPG Signature: https://releases.mattermost.com/5.37.9/mattermost-team-5.37.9-linux-amd64.tar.gz.sig
