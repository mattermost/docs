...
- **:doc:`Security-Optimized Mobility </security-guide/mobile-security>`** `Enterprise Advanced` — Combines jailbreak/root detection, biometric authentication, data-at-rest encryption, and screenshot prevention into a unified mobile security posture for BYOD and mission-critical device scenarios, without requiring MDM.
