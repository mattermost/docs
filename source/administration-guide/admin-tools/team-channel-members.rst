...
Alternatively, system admins can use the mmctl ``mmctl team archive`` to archive teams. See the :ref:`mmctl product documentation <administration-guide/admin-tools/mmctl-command-line-tool:mmctl team archive>` for details.
...
Alternatively, system admins can use the mmctl ``mmctl team restore`` to archive teams. See the :ref:`mmctl product documentation <administration-guide/admin-tools/mmctl-command-line-tool:mmctl team restore>` for details.
