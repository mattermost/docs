...
If you plan to synchronize system properties with your AD/LDAP or SAML identity provider, ensure AD/LDAP or SAML synchronization is already enabled and configured. See the :doc:`AD/LDAP groups </administration-guide/identity-access/ad-ldap-groups-synchronization>` product documentation or :ref:`SAML 2.0 <administration-guide/configuration-reference/authentication-configuration-settings:saml 2.0>` configuration settings documentation for details.
