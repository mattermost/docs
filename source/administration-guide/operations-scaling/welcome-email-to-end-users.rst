...
2. `Download <https://mattermost.com/apps>`__ the Mattermost apps for desktop and mobile. See the :doc:`Use Mattermost </end-user-guide/end-user-guide-index>` end user documentation for details on how to get up and running quickly.
