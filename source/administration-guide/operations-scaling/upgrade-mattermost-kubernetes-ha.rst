...
4. Use monitoring tools to confirm application health and performance. See the :doc:`Performance monitoring with Prometheus and Grafana </administration-guide/operations-scaling/deploy-prometheus-grafana-for-performance-monitoring>` documentation or the :doc:`Metrics plugin </administration-guide/operations-scaling/performance-monitoring-metrics>` documentation for details on collecting and reviewing performance metrics.
