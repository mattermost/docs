...
This page describes the Mattermost reference architecture designed for the load of up to 30000 concurrent users. Unsure which reference architecture to use? See the :doc:`scaling for enterprise </administration-guide/operations-scaling/scaling-for-enterprise>` documentation for details.
