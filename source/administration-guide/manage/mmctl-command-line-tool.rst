...
From Mattermost v11.7.0, you can list all available roles. System admins can use this command to discover role names (for example, ``system_admin`` or ``system_user``) before assigning or unassigning roles with other mmctl commands.
