...
It is possible to customize certain parts of the webapp without forking by using our :doc:`Custom Branding <custom-branding-tools>` settings. 
...
2. Customize or hide help and support links by modifying your :ref:`configuration settings <administration-guide/configuration-reference/site-configuration-settings:customization>`.
