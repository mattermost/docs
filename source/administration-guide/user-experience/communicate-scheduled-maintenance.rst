...
- `Mattermost Banner notification <#banner-notification>`__: Set a :doc:`system-wide notification </administration-guide/admin-tools/system-wide-notifications>` to display at the top of the Mattermost instance ahead of the maintenance window and outage.
