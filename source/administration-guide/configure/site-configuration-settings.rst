...
.. config:setting:: allow-users-to-view-archived-channels
  ...
  This setting is always enabled as of Mattermost v11.0 and is no longer configurable. Users can always access archived channels where they are members.

Allow users to view archived channels
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. note::
  As of Mattermost v11.0, this setting is always enabled and no longer configurable. Users can always access archived channels where they are members.

+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+
| This setting is always enabled and no longer configurable in Mattermost v11.0+.                              | - System Config path: **Site Configuration > Users and Teams**                                |
