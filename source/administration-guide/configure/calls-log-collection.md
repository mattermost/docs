# Mattermost Calls Log Collection

```{include} ../../_static/badges/all-commercial.md
```

When working through a Calls issue — either independently or with Mattermost Support — gathering the right log files is a critical first step. This guide covers how to collect logs from each component. For symptom-based troubleshooting, see [Deploy Mattermost Calls](calls-deployment.md#appendix-a-troubleshooting-by-symptom).
