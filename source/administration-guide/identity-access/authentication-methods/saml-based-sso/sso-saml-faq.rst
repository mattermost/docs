...
Yes, but this relies on AD/LDAP to do so. Currently, we do not support SCIM. See :ref:`"How do I deactivate users?" <administration-guide/identity-access/ad-ldap:how do i deactivate users?>` for more information. 

How do I migrate users from one authentication method (e.g. email) to SAML?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

See the :ref:`mmctl user migrate-auth <administration-guide/admin-tools/mmctl-command-line-tool:mmctl user migrate-auth>` command documentation for details.
