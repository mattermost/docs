...
.. note::
    ...
    - System admins can :ref:`disable notification monitoring data collection <administration-guide/configuration-reference/site-configuration-settings:enable notification monitoring>` through the System Console.
