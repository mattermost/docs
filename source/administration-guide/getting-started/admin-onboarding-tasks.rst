...
3. Begin to onboard users by enabling account creation or by connecting an authentication service to assist with user provisioning.
 ...
 - Users can be pre-provisioned with migration and bulk loading data processes based on prior collaboration systems. Please see our :doc:`migration guide </administration-guide/getting-started/migrating-to-mattermost>` and :doc:`bulk loading documentation </administration-guide/getting-started/bulk-loading-data>` for additional details.
...
If your organization requires more structure and project management artifacts for the implementation of Mattermost, please see our :doc:`Enterprise roll out checklist </administration-guide/getting-started/roll-out-checklist>`.
