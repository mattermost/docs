...
3. `Download <https://mattermost.com/apps>`__ the Mattermost apps for desktop and mobile. Refer to the :doc:`Use Mattermost </end-user-guide/end-user-guide-index>` end user documentation on how to get up and running quickly.
