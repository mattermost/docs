...
.. Users trying to access this page are now redirected to /administration-guide/getting-started/migrating-to-mattermost.html#migrating-from-slack instead
...
#. Configure :doc:`Active Directory/LDAP </administration-guide/identity-access/ad-ldap>` or :doc:`SAML Single Sign-on </administration-guide/identity-access/authentication-methods/saml-based-sso/sso-saml>` from the **System Console**.
