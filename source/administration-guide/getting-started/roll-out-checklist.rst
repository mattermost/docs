...
2. `Download <https://mattermost.com/apps>`__ the Mattermost apps for desktop and mobile. See the :doc:`End User Guide </end-user-guide/end-user-guide-index>` for details on how to get up and running with Mattermost quickly.
