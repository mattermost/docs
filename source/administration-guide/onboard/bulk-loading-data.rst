...
From Mattermost v9.5, the mmctl bulk import process command in :ref:`local mode <administration-guide/manage/mmctl-command-line-tool:local mode>` supports processing an import file without uploading it to the server. 
