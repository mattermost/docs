...
- `Compliance Export <#administration-guide/compliance-security-auditing/compliance-export>`__
...
Set how long Mattermost keeps messages across all teams and channels. This value is not used for any teams and channels that have a custom retention policy applied . Requires the :ref:`global retention policy for messages <administration-guide/configuration-reference/compliance-configuration-settings:global retention policy for messages>` configuration setting to be set to ``true``.
...
.. note::
  ...
  From Mattermost v9.5, ``MessageRetentionDays`` has been deprecated in favor of ``MessageRetentionHours``. See :doc:`deprecated configuration settings </administration-guide/configuration-reference/deprecated-configuration-settings>` for details.
...
.. note::
  ...
  From Mattermost v9.5, ``FileRetentionDays`` has been deprecated in favor of ``FileRetentionHours``. See :doc:`deprecated configuration settings </administration-guide/configuration-reference/deprecated-configuration-settings>` for details.
...
.. note::
  ...
  - This global configuration setting must be enabled with mmctl using the :ref:`mmctl config set <administration-guide/admin-tools/mmctl-command-line-tool:mmctl config set>` command.
...
.. config:setting:: enable-administration-guide/compliance-security-auditing/compliance-export
...
**True**: Mattermost will generate a compliance export file that contains all messages that were posted in the last 24 hours. The export task is scheduled to run once per day. See the :doc:`documentation to learn more </administration-guide/compliance-security-auditing/compliance-export>`.
...
.. config:setting:: administration-guide/compliance-security-auditing/compliance-export-time
