...
5. From Mattermost v10.10, you can optionally preserve pinned posts when data retention policies delete messages by enabling :ref:`Preserve pinned posts <administration-guide/configuration-reference/compliance-configuration-settings:preserve pinned posts>`. Once enabled, pinned posts won't be deleted even if they exceed the configured retention period.
