...
.. note::
  ...
  Bots, deactivated users, and synthetic users in :doc:`Microsoft Teams integrations </end-user-guide/collaborate/collaborate-within-connected-microsoft-teams>` and :doc:`connected workspaces </administration-guide/getting-started/connected-workspaces>` users aren't counted towards the total number of active users.
