...
|                       |                                                                                                          | See the :doc:`Upgrade Mattermost </administration-guide/operations-scaling/upgrading-mattermost-server>` product documentation for details on upgrading your workspace.         |
+-----------------------+----------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                       |                                                                                                          | - :ref:`Configure session length <administration-guide/configuration-reference/environment-configuration-settings:session lengths>`                                                |
|                       | - **File Storage**: Write access to the configured file storage location is required.                    | - :ref:`Configure file storage <administration-guide/configuration-reference/environment-configuration-settings:file storage>`                                                     |
|                       |                                                                                                          |                                                                                                                                                                      |
...
|                       |                                                                                                          | See the :ref:`Web server configuration settings <administration-guide/configuration-reference/environment-configuration-settings:web server>` product documentation to learn more: |
+-----------------------+----------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
