...
- **Email address**: Enables you to :ref:`enter an email address <administration-guide/configuration-reference/site-configuration-settings:report a problem email address>` that users will be prompted to send a message to when they choose **Report a Problem** in Mattermost.
- **Custom link**: Enables you to :ref:`enter a URL <administration-guide/configuration-reference/site-configuration-settings:report a problem link>` that users will be directed to when they choose **Report a Problem** in Mattermost.
...
|   :doc:`SAML </administration-guide/identity-access/authentication-methods/saml-based-sso/sso-saml>` or                                       |                                                                                      |
|   :doc:`LDAP </administration-guide/identity-access/ad-ldap>` if first name and last name               |                                                                                      |
...
.. note::
  See the :ref:`performance monitoring <administration-guide/operations-scaling/deploy-prometheus-grafana-for-performance-monitoring:getting started>` documentation 
...
|   :ref:`Allow file downloads on mobile <administration-guide/configuration-reference/site-configuration-settings:allow file downloads on mobile>`   | - Environment variable: ``MM_FILESETTINGS_MOBILEENABLESECUREFILEPREVIEW``                         |
...
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
| - **true**: **(Default)** System admins will receive :doc:`in-product notices </administration-guide/admin-tools/in-product-notices>` about server upgrades and administration features.         | - System Config path: **Site Configuration > Notices** -                                   |
...
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+
| - **true**: **(Default)** All users receive :doc:`in-product notices </administration-guide/admin-tools/in-product-notices>` about client upgrades and end user features.           | - System Config path: **Site Configuration > Notices**                                  |
...
When connected workspaces are enabled, system admins can :doc:`create and manage connected workspaces </administration-guide/getting-started/connected-workspaces>` in the System Console by going to **Site Configuration > Connected Workspaces**.
