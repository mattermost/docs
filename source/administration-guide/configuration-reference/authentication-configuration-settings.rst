...
.. config:setting:: restrict-account-creation-to-specified-email-domains
  ...
  You **must** set `Require Email Verification <https://docs.mattermost.com/administration-guide/configuration-reference/configuration-settings.html#require-email-verification>`__ to ``true`` for the restriction to function.
...
| You **must** set :ref:`Require Email Verification <administration-guide/configuration-reference/authentication-configuration-settings:require email verification>`   | - ``config.json`` setting: ``TeamSettings`` > ``RestrictCreationToDomains``  |
...
.. note::
  ...
  See the :ref:`configuration <administration-guide/configuration-reference/site-configuration-settings:forgot password custom link>` documentation for details.
...
.. config:setting:: enable-multi-factor-authentication
  ...
  - **true**: Users who sign-in with AD/LDAP or an email address have the option to add `multi-factor authentication <https://docs.mattermost.com/administration-guide/identity-access/multi-factor-authentication.html>`__ to their accounts.
...
|   :doc:`multi-factor authentication </administration-guide/identity-access/multi-factor-authentication>` to their accounts.    | - ``config.json`` setting: ``ServiceSettings`` > ``EnableMultifactorAuthentication`` > ``false`` |
...
.. config:setting:: enforce-multi-factor-authentication
  ...
  - **true**: Requires `multi-factor authentication (MFA) <https://docs.mattermost.com/administration-guide/identity-access/multi-factor-authentication.html>`__ for users who sign-in with AD/LDAP or an email address.
...
|   <https://docs.mattermost.com/administration-guide/identity-access/multi-factor-authentication.html>`__      | - ``config.json`` setting: ``ServiceSettings`` > ``EnforceMultifactorAuthentication`` > ``false`` |
...
.. note::
  This filter is only used when AD/LDAP Group Sync is enabled. See :doc:`AD/LDAP Group Sync </administration-guide/identity-access/ad-ldap-groups-synchronization>` for more information.
...
.. note::
  If a user's ID Attribute changes, a new Mattermost account is created that is not associated with the previous account. If you need to change this field after users have signed-in, use the :ref:`mmctl ldap idmigrate <administration-guide/admin-tools/mmctl-command-line-tool:mmctl ldap idmigrate>` command.
...
.. note::
  This attribute is only used when AD/LDAP Group Sync is enabled and it is **required**.  See the :doc:`AD/LDAP Group Sync documentation </administration-guide/identity-access/ad-ldap-groups-synchronization>` for more information.
...
.. config:setting:: enable-login-with-saml
  ...
  - **true**: Enables sign-in with SAML. See `SAML Single Sign-On <https://docs.mattermost.com/administration-guide/identity-access/authentication-methods/saml-based-sso/sso-saml.html>`__ to learn more.
...
+---------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------+
| - **true**: Enables sign-in with SAML. See :doc:`SAML Single Sign-On </administration-guide/identity-access/authentication-methods/saml-based-sso/sso-saml>` to learn more.         | - System Config path: **Authentication > SAML 2.0**                  |
...
See :doc:`AD/LDAP Setup </administration-guide/identity-access/ad-ldap>` to learn more.
...
For more information, see :doc:`AD/LDAP Setup </administration-guide/identity-access/ad-ldap>` for details. 
...
| See :doc:`Google Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-google>` implementation instructions.                                                |                                                                       |
+---------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------+
...
| See :doc:`Google Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-google>`  for instructions that can be used to implement Google OAuth or OpenID authentication.                                                     | - Environment variable: ``MM_GOOGLESETTINGS_ID``      |
|                                                                                                                                                                                                                        |                                                       |
| String input.                                                                                                                                                                                                          |                                                       |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------+
...
.. note::
  See the :doc:`Entra ID Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-entraid>` documentation for details.
...
.. note::
  See the :doc:`GitLab Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-gitlab>` documentation for details.
...
.. note::
  See **Step 2** of the :doc:`GitLab Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-gitlab>` documentation for details.
...
| See :ref:`Configure Mattermost for Google Apps SSO <administration-guide/identity-access/authentication-methods/sso/sso-google:step 3: configure mattermost for google apps sso>`.         | - Environment variable: ``MM_GOOGLESETTINGS_DISCOVERYENDPOINT``       |
|                                                                                                                                                         |                                                                       |
...
|                                                                                                                  | - ``config.json`` setting: ``GoogleSettings`` > ``Id``    |
| See :doc:`Google Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-google>` implementation instructions.         | - Environment variable: ``MM_GOOGLESETTINGS_ID``          |
|                                                                                                                  |                                                           |
| String input.                                                                                                    |                                                           |
+------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------+
...
|                                                                                                                   | - ``config.json`` setting: ``GoogleSettings`` > ``Secret``|
| See :doc:`Google Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-google>`  implementation instructions.         | - Environment variable: ``MM_GOOGLESETTINGS_SECRET``      |
|                                                                                                                   |                                                           |
| String input.                                                                                                     |                                                           |
+-------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------+
...
|                                                                                                                      | - Environment variable: ``MM_OFFICE365SETTINGS_ENABLE``                   |
| See :doc:`Entra ID Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-entraid>` implementation instructions.          |                                                                           |
+----------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+
...
|                                                                                                                      | - ``config.json`` setting: ``Office365Settings`` > ``DirectoryId`` |
| See :doc:`Entra ID Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-entraid>` implementation instructions.          | - Environment variable: ``MM_OFFICE365SETTINGS_DIRECTORYID``       |
|                                                                                                                      |                                                                    |
| String input.                                                                                                        |                                                                    |
+----------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------+
...
| See :doc:`Entra ID Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-entraid>` implementation instructions.                                                                                                | - Environment variable: ``MM_OFFICE365SETTINGS_DISCOVERYENDPOINT``                                                 |
|                                                                                                                                                                                                            |                                                                                                                    |
...
|                                                                                                                      | - ``config.json`` setting: ``Office365Settings`` > ``Id`` |
| See :doc:`Entra ID Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-entraid>` implementation instructions.          | - Environment variable: ``MM_OFFICE365SETTINGS_ID``       |
|                                                                                                                      |                                                           |
| String input.                                                                                                        |                                                           |
+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------+
...
|                                                                                                                      | - ``config.json`` setting: ``Office365Settings`` > ``Secret``  |
| See :doc:`Entra ID Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-entraid>` implementation instructions.          | - Environment variable: ``MM_OFFICE365SETTINGS_SECRET``        |
|                                                                                                                      |                                                                |
| String input.                                                                                                        |                                                                |
+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------+
...
| See :doc:`OpenID Connect Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-openidconnect>` implementation instructions.         |                                                                        |
+---------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------+
...
|                                                                                                        |                                                                       |
| See :doc:`OpenID Connect Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-openidconnect>`             |                                                                       |
...
| See :doc:`OpenID Connect Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-openidconnect>` implementation instructions.         | - Environment variable: ``MM_OPENIDSETTINGS_ID``          |
|                                                                                                                                 |                                                           |
| String input.                                                                                                                   |                                                           |
+---------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------+
...
| See :doc:`OpenID Connect Single Sign-On </administration-guide/identity-access/authentication-methods/sso/sso-openidconnect>` implementation instructions.         | - Environment variable: ``MM_OPENIDSETTINGS_SECRET``      |
|                                                                                                                                 |                                                           |
| String input.                                                                                                                   |                                                           |
+---------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------+
