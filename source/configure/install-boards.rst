...
See the :doc:`navigate boards </boards/navigate-boards>` documentation to learn how to create and access boards.

Work with boards
-----------------

See the :doc:`project and task management </guides/project-task-management>` end user documentation to learn how to align, define, organize, track, and manage work across teams.