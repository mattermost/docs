...
.. important::
  ...
  The server must be connected to the internet to generate previews. This connection can be established through a :doc:`firewall or outbound proxy </deploy/server/preparations#outbound-proxy-configuration>` if necessary.
