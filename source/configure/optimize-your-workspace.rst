...
+-----------------------+----------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| File storage access   | -  Is file storage available on server start up?                                                         | See the product documentation to learn more about configuring file storage for your self-hosted Mattermost deploymment:                                              |
| (Self-hosted)         | - Does Mattermost have sufficient write access to local or cloud-based file storage?                     |                                                                                                                                                                      |
|                       |                                                                                                          | - `File storage configuration settings </configure/environment-configuration-settings.html#file-storage>`__                                                          |
+-----------------------+----------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+