...
.. tip::
   ...
   The bleve index directory path isn't required to exist within the ``mattermost`` directory. When it exists outside of the ``mattermost`` directory, additional steps aren't needed to preserve or reindex these files as part of a Mattermost upgrade. See our `Upgrading Mattermost Server <https://docs.mattermost.com/administration/upgrade.html#upgrading-mattermost-server>`__ documentation for details.
