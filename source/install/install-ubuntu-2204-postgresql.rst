.. _install-ubuntu-2204-postgresql:
...
**To install PostgreSQL on Ubuntu Server 22.04:**
...
By default on Ubuntu 22.04 this should be Postgres 14, however, Confirm this version is PostgreSQL version 10 or higher. You can do this by running ``psql -V``. If this isn't version 10 or higher you can reference the PostgreSQL documentation `here <https://www.postgresql.org/download/linux/ubuntu/>`__ to install an updated version of PostgreSQL.
...
7. Log out of the *postgres* account if you logged into it on step 2.
