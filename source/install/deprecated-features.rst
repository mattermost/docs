...
- In-product GIF picker powered by Gfycat `is being discontinued <https://techcrunch.com/2023/07/05/gfycat-shuts-down-on-september-1/>`_. Gfycat will be replaced with GIPHY in the v9.0 release.
