...
3. Navigate to the release page for `version v5.1.0 <https://github.com/mattermost/desktop/releases/tag/v5.1.0>`__ and download the appropriate installer for your version of Windows (32bit vs. 64bit).
...
Note: Current version is 5.1.0. In the future, you may need to change this command accordingly.
