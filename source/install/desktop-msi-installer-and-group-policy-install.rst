...
3. Navigate to the release page for `version v5.2.1 <https://github.com/mattermost/desktop/releases/tag/v5.2.1>`__ and download the appropriate installer for your version of Windows (32-bit vs. 64-bit).

4. Download the `source.zip <https://github.com/mattermost/desktop/archive/v5.2.1.zip>`__ file as well to extract group policy files.
...
1. Browse to the folder the above files were downloaded to and unzip the ``desktop-5.2.1.zip`` file in place.
...
2. Navigate to the unzipped ``desktop-5.2.1\resources\windows\gpo`` folder and copy the contents.
...
``msiexec /i mattermost-desktop-v5.2.1-x64.msi /qn``
