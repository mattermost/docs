...
New releases are announced via our community server, as well as social media.
...
manifest, pointing to the address you just copied. For example, on AWS you would do this within a hosted zone in
Route53. Use the required ``ingressName`` URL in your browser to directly access blue or green at any time.
