...
.. tab:: Latest release
  ...
  .. raw:: html
    ...
    <div class="mm-code-copy mm-code-copy--long" data-click-method="Tarball latest" data-click-command="Download the latest release">

      <div class="mm-code-copy__wrapper">
        <code class="mm-code-copy__text mm-code-copy__trigger" data-click-el="Snippet">
        wget https://releases.mattermost.com/9.8.1/mattermost-9.8.1-linux-amd64.tar.gz
        </code>
...
.. tab:: Current ESR
  ...
  .. raw:: html
    ...
    <div class="mm-code-copy mm-code-copy--long" data-click-method="Tarball ESR" data-click-command="Download the ESR release">

      <div class="mm-code-copy__wrapper">
        <code class="mm-code-copy__text mm-code-copy__trigger" data-click-el="Snippet">
        wget https://releases.mattermost.com/9.5.6/mattermost-9.5.6-linux-amd64.tar.gz
        </code>
        <span class="mm-code-copy__copied-notice">Copied to clipboard</span>
      </div>
...
.. tab:: Older releases
  ...
  If you are looking for an older release, Enterprise and Team Edition releases can be found in our :doc:`version archive </lifecycle/version-archive>` documentation.
