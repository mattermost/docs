...
3. Download :doc:`the latest version of the Mattermost Server </lifecycle/version-archive>`. In the following command, replace ``X.X.X`` with the version that you want to download:
