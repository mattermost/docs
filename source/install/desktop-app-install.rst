...
1. Download the latest version of the Mattermost desktop app:
  ...
  - `32/64-bit version of Windows <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-setup-5.0.2-win.exe>`__

2. From the **\Downloads** folder right-click on the file ``mattermost-desktop-setup-5.0.2-win.exe`` and select **Open**.
...
- MSI for `64-bit version of Windows <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-x64.msi>`__
- MSI for `32-bit version of Windows <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-x86.msi>`__
...
1. Download the latest version of the Mattermost desktop app:
  - `Intel systems <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-mac-x64.dmg>`__
  - `M1 systems <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-mac-m1.dmg>`__ (Beta)
...
1. Download the latest version of the Mattermost desktop app:
 ...
 - 64-bit systems: `mattermost-desktop-5.0.2-linux-x64.tar.gz <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-linux-x64.tar.gz>`__
 - 32-bit systems: `mattermost-desktop-5.0.2-linux-ia32.tar.gz <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-linux-ia32.tar.gz>`__
...
- 64-bit systems
  `mattermost-desktop-5.0.2-linux-amd64.deb <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-linux-amd64.deb>`__
- 32-bit systems
  `mattermost-desktop-5.0.2-linux-i386.deb <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-linux-i386.deb>`__

2. At the command line, execute one of the following commands depending on the package that you downloaded:

- 64-bit systems
  ``sudo dpkg -i mattermost-desktop-5.0.2-linux-amd64.deb``
- 32-bit systems
  ``sudo dpkg -i mattermost-desktop-5.0.2-linux-i386.deb``
...
- 32-bit systems
  `mattermost-desktop-5.0.2-linux-i686.rpm <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-linux-i686.rpm>`__
- 64-bit systems
  `mattermost-desktop-5.0.2-linux-x86_64.rpm <https://releases.mattermost.com/desktop/5.0.2/mattermost-desktop-5.0.2-linux-x86_64.rpm>`__

2. At the command line, execute one of the following commands depending on the package that you downloaded:

- 32-bit systems
  ``sudo rpm -i mattermost-desktop-5.0.2-linux-i686.rpm``
- 64-bit systems
  ``sudo rpm -i mattermost-desktop-5.0.2-linux-x86_64.rpm``
