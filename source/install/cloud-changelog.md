...
- [Release 2022-07-27](#release-2022-07-27)
...
#### Administration
 ...
 - Added a new static system-level role called Custom Group Manager. This role has permissions to create, edit, and delete custom user groups via the existing front-end group management functionality. This functionality exists in Channels and can be used to assign individual users this ability when the mentioned Custom Groups permissions are removed for All Members via the **System Console** (**System Console > Permissions > Edit Scheme > Custom Groups**).
