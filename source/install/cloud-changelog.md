...
#### Administration
 ...
 - Added a new static system-level role called Custom Group Manager. This role has permissions to create, edit, and delete custom user groups via the existing front-end group management functionality that exists in Channels.
