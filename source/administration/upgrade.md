...
- [Upgrade Enterprise Edition](http://docs.mattermost.com/administration/upgrade.html#upgrade-enterprise-edition)
  - [Upgrade Enterprise Edition to 3.2.x and later](http://docs.mattermost.com/administration/upgrade.html#upgrade-enterprise-edition-to-3-2-x-and-later)
  - [Upgrade Enterprise Edition to 3.1.x](http://docs.mattermost.com/administration/upgrade.html#upgrade-enterprise-edition-to-3-1-x)
...
Upgrading to `v3.2.x` and `v3.3.x` follows the procedure to [upgrade to `v3.1.x` and later](http://docs.mattermost.com/administration/upgrade.html#upgrade-enterprise-edition-to-3-1-x), but there is a breaking change where under `LdapSettings` in `config.json` `"FirstNameAttribute"` and `"LastNameAttribute"` are now required fields.
