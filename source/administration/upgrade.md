...
### Upgrading to Mattermost 3.0.x from 2.x
...
`EDITION` refers to your Mattermost Edition, either `team` or `enterprise`.

1. Download Mattermost 3.0.2
      ...
      2. Run `wget https://releases.mattermost.com/X.X.X/mattermost-EDITION-X.X.X-linux-amd64.tar.gz` to download the appropriate new version. 
...
4. Install new version
      ...
      2. Run `tar -xvzf mattermost-EDITION-X.X.X-linux-amd64.tar.gz` to decompress the upgraded version and replace the current version of Mattermost on disk, where `X.X.X` is the version number to which you are upgrading.
...
### Upgrading Mattermost prior to 3.x
...
1. Download the **appropriate next upgrade** of your Team Edition server and note any compatibility procedures
      ...
      3. Use the [Version Archive table](http://docs.mattermost.com/administration/upgrade.html#version-archive) to find the `[RELEASE URL]` for your desired version and enter `wget [RELEASE URL]` to download. For example, to download `vX.X.X`, use `wget https://releases.mattermost.com/X.X.X/mattermost-EDITION-X.X.X-linux-amd64.tar.gz`.
...
5. Install new version
      1. Run `tar -xvzf mattermost-EDITION-X.X.X-linux-amd64.tar.gz` to decompress the upgraded version and replace the current version of Mattermost on disk, where `X.X.X` is the version number to which you are upgrading.  
