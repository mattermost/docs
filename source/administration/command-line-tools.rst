...
.. note::
When running Mattermost with the configuration stored in the database you might need to pass the database connection string when running CLI commands which can do this as follows: 
