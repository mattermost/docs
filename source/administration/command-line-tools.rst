...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  Description
    Move an existing outgoing webhook to another team and channel by by specifying its id. If the webhook to be moved has a channel id, it must have a new one specified when moving to a new team. 
