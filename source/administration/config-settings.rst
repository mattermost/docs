...
**Show nickname if one exists**: Displays the user's nickname. If the user does not have a nickname, their full name is displayed.

**Show first and last name**: Displays the user's full name. Recommended when using SAML or LDAP if first name and last name attributes are configured.
