...
The default recommendation for secure deployment is to host Mattermost within your own private network, with VPN clients on mobile, so that everything works under your existing security policies. If you choose to run Mattermost outside your private network, Mattermost-specific multi-factor authentication is available as an advanced feature with Enterprise Edition. 
