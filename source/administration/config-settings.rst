...
See `Advanced Logging Options Sample.json.zip <https://docs.mattermost.com/source/samples/Advanced.Logging.Options.Sample.json.zip>`__ for a sample configuration file. 
