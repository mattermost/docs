...
.. note::
   ...
   In a high-availability environment, using an environment variable to override a server license only affect the individual app server and doesn't propagate to other servers in the cluster.
