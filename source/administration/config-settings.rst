...
This setting only affects the UI, not permissions on the server. For instance, a Direct Mmessage channel can be created with anyone on the server regardless of this setting.
