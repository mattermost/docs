...
- **v5.23.1, release day TBD**
  - Fixing an issue where Content-Type is no longer optional in webhook requests and leads to errors. [MM-25677](https://mattermost.atlassian.net/browse/MM-25677)
