...
- **v5.35.1, release day TBD**
  - Investigating an issue where 5.35.0 migration is failing on MySQL installations with an "invalid connection" error. [MM-35767](https://mattermost.atlassian.net/browse/MM-35767)
