...
- **v5.31.4, released 2021-04-23**
  - Fixed an issue with short-circuit slash command hooks when a plugin consumed one for client-side processing. [MM-35074](https://mattermost.atlassian.net/browse/MM-35074)
