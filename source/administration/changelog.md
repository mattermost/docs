...
- **v5.29.2, released 2021-01-16**
  - Fixed an issue where a column in the ``ThreadMemberships`` table was missing. Admins planning to enable [Collapsed Reply Threads](https://mattermost.com/blog/dev-sneak-peek-collapsed-reply-threads/) (available in beta in Q1 2021) are recommended to upgrade to v5.29.2 or later.
