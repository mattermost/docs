...
### Notes on Patch Release
 ...
 - **v3.6.2, released 2017-01-31**
   ...
   - Note: 3.6.2 may cause WebSocket issues when using multiple Mattermost URLs through proxy forwarding. We're [tracking the issue here](https://mattermost.atlassian.net/browse/PLT-5635).
