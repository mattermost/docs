...
- **v5.18.2, released 2020-01-16**
  - Fixed an issue where the server crashed when a ``user_updated`` event was sent through a cluster to a guest user and the event did not reach the guest user. [MM-21481](https://mattermost.atlassian.net/browse/MM-21481)
