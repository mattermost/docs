...
- **v5.33.3, release day TBD**
  - Fixing an issue where Office 365 returns different ID attributes based on user type, causing an error for users with expired sessions when they try to sign in to Mattermost. [MM-34356](https://mattermost.atlassian.net/browse/MM-34356)
