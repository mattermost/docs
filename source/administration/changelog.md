...
- **v5.34.1, released 2021-04-15**
  - Fixed an issue where upgrading to 5.34.0 run a migration that could cause timeouts on MySQL installations. Upgrading to v5.34.1 may also execute missing migrations that were scheduled for 5.32.0. These additions can be lengthy on very big MySQL (version 5.x) installations.
