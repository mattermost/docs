...
2. `platform` binary has been renamed to mattermost for a clearer install and upgrade experience. Although not required, we recommentd **pointing your service file to the mattermost binary prior to upgrading**. All command line tools, including the bulk loading tool and developer tools, have also been renamed from platform to mattermost. [Ticket #9985](https://mattermost.atlassian.net/browse/MM-9985).
