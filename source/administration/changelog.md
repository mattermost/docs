...
- **v5.18.2, released 2020-01-16**
  - Fixed an issue with a panic in ``web.shouldSendEventToGuest`` triggered in cases where a user update event was sent to a guest user in a cluster setup. [MM-21481](https://mattermost.atlassian.net/browse/MM-21481)
