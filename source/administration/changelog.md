...
- Mattermost v3.1.0 contains [multiple security updates](XXX - http://about.mattermost.com/security-updates/). [Upgrading to Mattermost v3.1.0](http://docs.mattermost.com/administration/upgrade.html#upgrading-team-edition) is highly recommended.
...
- [Mattermost Translation Server](translate.mattermost.com) upgraded to better support for [localization process](http://docs.mattermost.com/developer/localization.html).

Integrations

- Integrations now support advanced formatting through [message attachments](XXX).
...
- (E20 and higher): Added support for [high availability database configurations](XXX - https://github.com/mattermost/docs/pull/221/files) using read replicas and a manual failover process to deploy database reconfigurations without stopping the Mattermost server. 
