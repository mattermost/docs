...
- **v5.22.3, release day TBD**
  - Fixing an issue where channels are shown as read-only when [Channel Moderation feature](https://docs.mattermost.com/deployment/advanced-permissions.html#channel-moderation-beta-e20) is used on High Availability environments. [MM-24959](https://mattermost.atlassian.net/browse/MM-24959)
