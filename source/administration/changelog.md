...
### Known Issues
 - Text alignment in right-to-left support does not work correctly in v5.34. This is fixed in the latest version of the [mattermost-rtl plugin](https://github.com/QueraTeam/mattermost-rtl).
