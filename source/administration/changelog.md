...
- **v5.18.1, release day TBD**
  - Fixing an issue where migrating accounts from email to SAML fails. [MM-21472](https://mattermost.atlassian.net/browse/MM-21472)
