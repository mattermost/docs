...
3. [Download Go 1.7 or higher](http://golang.org/dl/) and Node.js using Homebrew.
...
4. [Download Go 1.7 or higher](http://golang.org/dl/).
...
3. Download and install Go 1.7 or higher from [https://golang.org/dl/](https://golang.org/dl/)
...
You need to upgrade to Go 1.7 or higher. We don't support earlier versions than that.
