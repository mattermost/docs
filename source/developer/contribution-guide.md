...
3. Your code follows the [Mattermost Style Guide](http://docs.mattermost.com/developer/style-guide.html) and you've run `make check-style` to find style errors.
