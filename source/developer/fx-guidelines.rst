...
Instructions containing a link to an external resource (ie: a blog article or docs.mattermost.com), should not be hard-coded.  A redirect page from about.mattermost.com should be used in product instructions.  A about.mattermost.com page can be requested from the Product team at Mattermost. 
