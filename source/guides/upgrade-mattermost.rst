Keep your Mattermost workspace current
======================================

.. include:: ../_static/badges/allplans-selfhosted.rst
  :start-after: :nosearch:

The following resources will help you keep your Mattermost workspace current by upgrading to the latest release:
...
See the following resources to learn more about Mattermost releases, the release lifecycle, extended support releases, and version archives:
...
* **Release definitions** - Learn about the :doc:`Mattermost release schedule </upgrade/release-definitions>` and the types of releases available.
* **Release lifecycle** - Learn about :doc:`critical lifecycle dates </upgrade/release-lifecycle>`.
* **Extended support release** - Learn about Mattermost releases that have :doc:`extended release support </upgrade/extended-support-release>`.
* **Version archive** - :doc:`Download binaries </upgrade/version-archive>` for every previous Mattermost release.