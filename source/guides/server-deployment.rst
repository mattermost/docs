...
.. toctree::
   ...
   :titlesonly:
    ...
    Trial Mattermost using Docker </install/trial-mattermost-using-docker>
...
* :doc:`Trial Mattermost using Docker </install/trial-mattermost-using-docker>` - Learn how to evaluate Mattermost in a non-production environment using Docker.