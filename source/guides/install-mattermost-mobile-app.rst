...
The Mattermost mobile app is available for `iOS </install/install-ios-app>` and `Android </install/install-android-app>` devices. You can connect the mobile app to both self-hosted and cloud-based Mattermost workspaces.
...
* :doc:`Mobile apps FAQs </deploy/mobile-faq>` - Answers to common mobile app questions.
* :doc:`Client-side data storage frequently asked questions </deploy/client-side-data>` - Learn what data is stored on a mobile browser or the mobile app. 