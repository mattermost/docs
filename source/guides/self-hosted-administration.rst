...
* :doc:`Include configuration in the Mattermost database </configure/configuration-in-your-database>` - Store Mattermost configuration information in your database rather than as a JSON file. We recommend this for High Availability environments.
