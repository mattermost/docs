...
* **Configure your workspace** - Mattermost offers extensive configuration options for both `self-hosted Mattermost servers and Mattermost Cloud workspaces <https://docs.mattermost.com/configure/configuration-settings.html>`__, and ensures that :doc:`deprecated configuration settings </configure/deprecated-configuration-settings>`__ no longer supported are clearly documented.
