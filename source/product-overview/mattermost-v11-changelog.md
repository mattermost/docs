...
#### Administration
 - Added a new [Post Exposure Report](https://docs.mattermost.com/administration-guide/manage/admin/content-flagging.html) feature to Data Spillage Handling workflow for content reviewers.
...
#### User Interface
 ...
 - Added a WYSIWYG editor option for message composition, allowing users to compose messages with rich-text formatting while preserving full markdown round-trip (in Beta and behind a feature flag).
