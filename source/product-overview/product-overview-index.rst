...
- Integrated ChatOps capabilities via :doc:`slash commands </integrations-guide/run-slash-commands>`, :ref:`bots </integrations-guide/integrations-guide-index:bots>`, and :doc:`webhooks </integrations-guide/webhooks-integrations>` for real-time automation and system alerts.
