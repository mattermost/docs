...
- **10.10.2, released 2025-08-14**
  ...
  - **[Platform] [Admin]** Upgraded to go1.24.5, and reverted to bullseye to maintain glibc <2.34 compatibility for older deployment environments [MM-64865](https://mattermost.atlassian.net/browse/MM-64865).
...
### Bug Fixes
 ...
 - **[End-user]** Fixed an issue with plugin dialogs triggering errors upon submission.
 ...
 - **[Admin]** Fixed an issue where an incorrect username and email were shown for remote users.
...
#### Changes to all plans:
 - **[Admin]** Under ``ExperimentalSettings`` in ``config.json``:
