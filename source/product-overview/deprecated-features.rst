...
- Experimental Bleve Search functionality will be retired. If Bleve is enabled, search will not work until ``DisableDatabaseSearch`` is set to ``false``. See more details in `this forum post <https://forum.mattermost.com/t/transitioning-from-bleve-search-in-mattermost-v11/22982>`__.
...
- **GitLab Omnibus and Mattermost Omnibus support deprecated** - Starting from Mattermost v11.0.0, both GitLab Omnibus and standalone Mattermost Omnibus deployments are deprecated. The last ``mattermost-omnibus`` release will be v10.12. Existing v10.x deployments continue to function with full support through the v10.11 ESR lifecycle (through August 2026). See the :ref:`Omnibus Migration Guide <deployment-guide/server/server-deployment-planning:omnibus migration guide>` for migration options and the `forum post <https://forum.mattermost.com/t/mattermost-omnibus-to-reach-end-of-life-v11/25175>`__ for more details.
