...
- Starting with Mattermost Mobile App v2.45 (October 2026), the minimum supported iOS version will be v17. Devices running iOS v16 or earlier will no longer receive new versions of the app from the App Store; the installed version will continue to work but will not receive further updates, including security fixes. Users should update to iOS v17 or newer before the v2.45 release. See the `forum post <https://forum.mattermost.com/t/deprecation-notice-ios-16-versions/26074>`__ for full details.
