...
- Omnibus support has been deprecated. The last ``mattermost-omnibus`` release was v10.12. See more details in `this forum post <https://forum.mattermost.com/t/mattermost-omnibus-to-reach-end-of-life-v11/25175>`__. Learn how to `move a GitLab Omnibus instance of Mattermost <https://docs.mattermost.com/administration-guide/onboard/migrating-to-mattermost.html>`__.
