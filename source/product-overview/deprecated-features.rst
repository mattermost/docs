...
- The bcrypt password hashing method will be deprecated in favor of PBKDF2. Downgrading from v11 to a previous version will make users unable to login again until upgrading back to v11.
