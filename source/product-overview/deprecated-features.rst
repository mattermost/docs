...
- Omnibus support will be deprecated. The last ``mattermost-omnibus`` release will be v10.12. **Important**: Existing Omnibus deployments on v10.x versions will continue to function normally and receive support through the v10.11 ESR lifecycle. See the :ref:`Omnibus migration section <deployment-guide/server/server-deployment-planning:omnibus migration guidance>` for detailed migration planning and the `forum post <https://forum.mattermost.com/t/mattermost-omnibus-to-reach-end-of-life-v11/25175>`__ for more details.
