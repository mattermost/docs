...
# Updated Sphinx version requirement for compatibility with new features.
needs_sphinx = "7.2"
...
extensions = [
        ...
        "config-setting-v2",
        "sphinx_inline_tabs",
        "sphinxcontrib.httpdomain",  # Added to support HTTP domain directives.
        ]
# Enable writing extensionless pages for cleaner URLs.
