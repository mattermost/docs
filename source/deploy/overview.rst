...
.. toctree::
  ...
  :hidden:
    ...
    Application Architecture </deploy/architecture>
    Server Application </deploy/server/overview>
    Desktop Application </deploy/desktop/overview>
    Mobile Application </deploy/mobile/overview>
