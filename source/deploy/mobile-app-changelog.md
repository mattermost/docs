...
### Known Issues
 - Popovers, such as emoji selectors and the channel context menu, may be non-functional in the mobile app [MM-56582](https://mattermost.atlassian.net/browse/MM-56582). A workaround is to disable **Reduce Motion** accessibility option in your device settings and then re-launch the app.
...
Note: Mattermost Mobile App v2.8.1 contains a high level security fix. Updating is recommended. Details will be posted on our security updates page 30 days after release as per the Mattermost Responsible Disclosure Policy.
