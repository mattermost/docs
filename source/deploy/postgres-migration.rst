...
This occurs because Mattermost does not allow creating channels with uppercase names - all new channels must have lowercase names.
...
Update all webhook payloads to use lowercase channel names.
