...
We also recommend following our `recommended steps to secure your deployment <https://docs.mattermost.com/deploy/consider-mobile-vpn-options.html?highlight=mobile%20vpn#consider-mobile-vpn-options>`__ and to review the following commonly-asked questions about data security on mobile devices:
