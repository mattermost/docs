...
See our :ref:`Mattermost AppConfig Values <deploy/mobile-appconfig:mattermost appconfig values>` documentation for details on the configuration options that can be sent from the EMM provider to Mattermost Mobile apps.
...
.. important::
    ...
    - With the release of Mattermost mobile app v2.0, mobile app v1.55 becomes the official :doc:`extended support mobile release </lifecycle/mattermost-mobile-releases>`, and will be supported for an extended timeframe.
