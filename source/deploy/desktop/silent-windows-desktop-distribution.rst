...
You can distribute the official Windows desktop app silently to end users, pre-configured with the server URL. Additionally, you can customize all of the :doc:`desktop app settings </preferences/customize-desktop-app-experience>`, except the **Start app on login** option.

.. tip::

  Want to :ref:`perform a silent installation of the desktop app MSI <deploy/desktop/desktop-msi-installer-and-group-policy-install:silent installation>` instead? 
