...
6. The case study coordinator also commissions a banner to be included in the case study blog post. A language banner is used as a template: https://drive.google.com/drive/folders/0Bx-9w8QDFlfcNHExbzFfbUhONWc
7. The case study coordinator creates a draft blog post (unpublished) on the Mattermost staging server. The draft will then be reviewed for formatting, grammar, and so on.
