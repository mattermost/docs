...
4. **Illustrative**: Try to find screenshots that are representative of the feature. To choose the best screenshot image, follow this order: end-user screenshot > screenshot of User Interface (e.g. System Console) > screenshot of help text > screenshot of documents > screenshot of a code mentioning the feature and/or Mattermost.
