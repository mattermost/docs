...
5. PM Release Manager:
    - Review release outline together and decide order of features for release announce.
    - PM release manager sends to Marketing to work on release announce draft. [See example](https://oss.mattermost.com/mattermost/pl/5t459hruhfd7bpi46tnf8zq8yo).
