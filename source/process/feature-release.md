...
2. Release Manager:
    ...
    - Draft a release summary for Support/Sales highlighting key things (e.g. new features, breaking changes, things we want feedback on, and potential support issues)
