...
A command like ``/docs search authentication`` queries your documentation system and returns a list of relevant articles as :doc:`MM Blocks </integrations-guide/mm-blocks>` or legacy `message attachments <https://developers.mattermost.com/integrate/reference/message-attachments/>`_ with links.