...
We test to 60,000 concurrent users and 60 million posts in the database regularly, and have a peak concurrent utilization safety factor of between 10 to 1 and 3 to 1, depending on distribution of an organization across time zones. Peak concurrent usage in a single timezone is generally around start of day, probably 9am, and lunch time when people are messaging to meet for a meal. In terms of database, we have tested up to 60 million 
