...
- **Data management service:** Connects to supported databases and file storage solutions (local, network-attached storage, Amazon S3, etc), and manages the reading and writing of data to and from them.
...
The following diagram is a suggested configuration for High Availablity databases through virtual IPs.
