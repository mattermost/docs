...
- Mattermost offers HIPAA-relevant **Technincal Safeguards** (described above), including: 
     - Access Control
     - Audit Controls
     - Integrity Controls
     - Transmission Security
     
- However it's critical to note HIPAA compliance has a host of additional requirements including: 
