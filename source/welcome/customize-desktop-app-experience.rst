...
.. tabs::
    ...
    .. tab:: Linux
        ...
        +----------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+
        | Flash app window and taskbar icon when a new message is received           | When a new message is received on any of your active teams and servers, your taskbar icon flashes.                                         |
