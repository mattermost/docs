...
Using Mattermost in a web browser or the desktop app, you can navigate between channels by selecting the **Find channel** option in the channel sidebar, or by pressing :kbd:`Ctrl` :kbd:`K` on Windows or Linux, or :kbd:`⌘` :kbd:`K` on Mac.
...
.. tip::
  ...
  Use the Find channels screen to review channel :doc:`member availability </preferences/set-your-status-availability>` at a glance.
