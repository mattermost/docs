...
.. tab:: Windows
  ...
  **Install the Mattermost Desktop App**
    ...
    1. Download the latest version of the Mattermost desktop app for the `64-bit version of Windows <https://releases.mattermost.com/desktop/5.11.1/mattermost-desktop-5.11.1-win-x64.msi>`_
    2. From the **\Downloads** folder, right-click on the file ``mattermost-desktop-setup-5.11.1-win.exe``, then select **Open** to start an installer for the app. Once finished, the Mattermost desktop app opens automatically.
...
.. tab:: macOS
  ...
  **Download the Desktop App from GitHub**
  ...
  1. Download the latest version of the Mattermost desktop app:
     ...
     - `Intel systems <https://releases.mattermost.com/desktop/5.11.1/mattermost-desktop-5.11.1-mac-x64.dmg>`_
     - `M1 systems <https://releases.mattermost.com/desktop/5.11.1/mattermost-desktop-5.11.1-mac-m1.dmg>`_ (Beta)
...
.. tab:: CentOS/RHEL
  ...
  **Install the Mattermost Desktop App**
  ...
  1. Download the latest version of the Mattermost desktop app for 64-bit systems: `mattermost-desktop-5.11.1-linux-x86_64.rpm <https://releases.mattermost.com/desktop/5.11.1/mattermost-desktop-5.11.1-linux-x86_64.rpm>`_

  2. At the command line, execute the following command:
    
    .. code-block:: sh

      sudo rpm -i mattermost-desktop-5.11.1-linux-x86_64.rpm
  ...
  To manually update the desktop app, run the following command:
    ...
    .. code-block:: sh
      ...
      sudo rpm -u mattermost-desktop-5.11.1-linux-x86_64.rpm
...
.. tab:: Generic Linux
  ...
  **Install the Desktop App's compressed tarball**
  ...
  1. Download the latest version of the Mattermost desktop app for 64-bit systems: `mattermost-desktop-5.11.1-linux-x64.tar.gz <https://releases.mattermost.com/desktop/5.11.1/mattermost-desktop-5.11.1-linux-x64.tar.gz>`_
