...
A system admin can view and manage users in **System Console > User Management > Users**. They can search users by name, filter users by teams, and filter to view other system admins, guests, as well as activated and inactive users. Only a system admin can make changes to another system admin user account in Mattermost.
