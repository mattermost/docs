...
You can mark channels as favorites so they're easy to access later.
...
.. tab:: Web/Desktop
  ...
  At the top of the page, select the |favorite-icon| icon next to the channel name. Select the |favorite-icon| icon again to remove that channel from your list of favorites.

  .. image:: ../images/favorite-channel-desktop.png
    :alt: Mark a channel as a favorite.

  Favorite channels display in the **Favorites** category at the top of your channel sidebar.
  ...
  .. tip::
    ...
    Alternatively, select the channel name, select the **View Info** |channel-info| icon, then select **Favorite** in the right pane. Select **Favorited** to remove the channel from your list of favorites.
