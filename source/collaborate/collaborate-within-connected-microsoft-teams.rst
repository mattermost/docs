...
In order to avoid double notifications, Mattermost won't deliver chat notifications when your Teams availability is set to **Available**, **Busy**, **Do not disturb**, or **Be right back** in Microsoft Teams.
