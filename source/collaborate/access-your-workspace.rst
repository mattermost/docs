...
.. tab:: Mobile
  ...
  1. Download and install the Mattermost mobile app from the `Apple App Store (iOS) <https://www.apple.com/app-store/>`_ or `Google Play Store (Android) <https://play.google.com/store/games?hl=en>`_.
