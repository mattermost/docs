...
To deploy the Team Edition, download the `Mattermost Team Edition binary </upgrade/version-archive.html#mattermost-team-edition>`__, and follow our standard install guides. The same applies to server upgrades.
