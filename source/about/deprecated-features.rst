...
- Beginning in Mattermost v11 (estimated in September 2025), Enterprise, Enterprise Advanced, and Professional customers can continue using the Playbooks plugin uninterrupted as they upgrade to newer Mattermost versions. For Professional customers, upgrades to Playbooks v2 will happen automatically with the release of Mattermost v11. <Forum post>
