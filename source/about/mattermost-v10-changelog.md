...
### Important Upgrade Notes
 - **System Requirements Update**: Minimum supported RedHat Enterprise Linux version has been updated to RHEL9+ due to GLIBC version requirements (GLIBC >=2.34). This also affects Oracle Linux, which now requires version 9+ since it a fork of RHEL. See the [Important Upgrade Notes](https://docs.mattermost.com/upgrade/important-upgrade-notes.html) for more details.
