...
.. toctree::
    ...
    Design decision questions <faq-design-decisions>
    Business questions <faq-business>
    Illicit use questions <faq-illicit-use>
...
* :doc:`Notifications questions <faq-notifications>` - What determines whether notifications are triggered?
...
* :doc:`Design decision questions <faq-design-decisions>` - Learn why Mattermost discloses whether or not an account exists when users enter an incorrect password.
* :doc:`Business questions <faq-business>` - Can you create an open source derivative work of Mattermost?
* :doc:`Illicit use questions <faq-illicit-use>` - Learn how to report illicit use of Mattermost software.
