...
- Single Sign-on with `GitLab </onboard/sso-gitlab.html>`__, `Google </onboard/sso-google.html>`__, `OpenID Connect </onboard/sso-openidconnect.html>`__, `SAML </onboard/sso-saml.html>`__ or `Office365 </onboard/sso-office.html>`__.
