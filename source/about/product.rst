...
Mattermost is built specifically for software development use cases and integrates deeply with a rich ecosystem of third-party developer tools. Mattermost gives companies full control over their data. Through self-hosted and private cloud deployment options and access to the source code, developers can contribute directly to a shared, flexible, and extensible platform built just for them.
...
We support key developer collaboration use cases:
 ...
 - **Developer workflow orchestration** for senior technical roles and CIO/CISO in companies that consider software development mission-critical. We make their digital enterprise operations successful with advanced developer workflows and integration with mission-critical applications.
...
------------------------
Mattermost is a platform of tools that provides workflow orchestration, eliminates context switching between channel-based communication, and offers prescribed workflows, and project workflows. The platform provides a single secure deployment, shared user management, and a common user experience with a comprehensive toolset enabling enterprise-grade collaboration. 
...
Stay connected through Channels to support your communication workflows
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Hit your milestones with Boards to support your project workflows
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
`Boards <https://docs.mattermost.com/guides/boards.html>`__ enable deliverable and task management solutions to help teams achieve project milestones using a familiar kanban board structure. Align work across the organization, and invest time and effort into what matters most. Stay on schedule with clearly defined tasks, owners, checklists, and deadlines. Increase transparency and keep all resources available including documents, images, and links. Additionally, boards are perfect for tracking tasks for sprints and features in roadmap planning.
