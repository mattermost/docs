...
- **Maximize your Microsoft investment** - Learn how to speed mission-critical outcomes by :doc:`supplementing existing investments in Microsoft Teams, M365, and Entra ID </about/maximize-microsoft-investment>` for everyday collaboration with Mattermost’s specialized workflow platform for technical and operational teams needing advanced customization, toolchain integration, and deployment to segregated networks. 
...
.. tip::
   ...
   Enroll in the following free Mattermost Academy courses to learn more leveraging Mattermost for your mission-critical operations:

   - `Release Management <https://academy.mattermost.com/p/release-management>`_
   - `Platform Engineering <https://academy.mattermost.com/p/platform-engineering>`_
   - `Agile Software Development <https://academy.mattermost.com/p/devops-in-mattermost>`_