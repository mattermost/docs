...
Your Mattermost Cloud workspace is considered "Active" when you're using it. If you stop using the workspace, have no activated users, have no user activity, or don't log in for 14 days, your workspace is moved to a "Hibernation" state.
