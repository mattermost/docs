...
If you’re using plugins that aren’t listed on the Marketplace, they won’t be included in the export and you won’t have access to them going forward. See the list of supported plugins by visiting the :ref:`integrations overview <about/integrations:plugins>` documentation. 
