...
.. tabs::
  ...
  .. tab:: Use mmctl
    ...
    2. While the job is running, you can check job status by running the `mmctl export job show <https://docs.mattermost.com/manage/mmctl-command-line-tool.html#mmctl-export-job-show>`__ command.
