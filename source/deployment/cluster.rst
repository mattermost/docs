...
From Mattermost Server v5.35, `gossip clustering can no longer be disabled <https://docs.mattermost.com/administration/config-settings.html#use-gossip>`__. All cluster traffic uses the gossip protocol.
