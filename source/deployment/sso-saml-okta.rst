...
9. Click **Finish**. On the next screen, click the **Sign On** tab and click **View Setup Instructions**.
	9.1 Select the **Identity Provider metadata** link and copy the link from the browser URL box. This will be used during the SAML configuration steps in the next section. 
