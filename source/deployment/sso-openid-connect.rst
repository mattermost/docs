...
Mattermost provides support for `GitLab <https://docs.mattermost.com/deployment/sso-gitlab.html#>`__, `Google Apps <https://docs.mattermost.com/deployment/sso-google.html>`__, and `Office 365 <https://docs.mattermost.com/deployment/sso-office.html>`__, as well as other OpenID Connect applications as a Single Sign-on (SSO) service for team creation, account creation, and user sign-in.
