...
- The version of Redis has [changed from 4.x to 5.x](#redis)
...
from 0.11.0 to 7.7.0. This updates the database version from `9.6` to `10.9`. This is not a drop in replacement. Manual
