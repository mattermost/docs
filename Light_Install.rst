...
- (रेकमेंडेड) आपके सर्वर से जुड़ा एक डोमेन नाम (यानी mymattermostserver.com)
- (रेकमेंडेड) अपनी टीम के सदस्यों के ईमेल ताकि आप उन्हें सर्वर पर आमंत्रित कर सकें
...
!नोट 
यद्यपि ओमनीबस को इनस्टॉल करने और कॉन्फ़िगर करने का अनुशंसित तरीका SSL इनेबल्ड है, यदि आपको उसके बिना (या डोमेन नाम के बिना) उपयोग या परीक्षण करना चाहते हैं, तो ये चलाएं: 
sudo MMO_HTTPS=false apt install mattermost-omnibus


जब आपका सर्वर चल रहा हो , तो उसे डोमेन नाम (यानी mymattermostserver.com) के माध्यम से नेविगेट करें,जो आपके सर्वर (या यदि आप डोमेन नाम का उपयोग नहीं कर रहे हैं तो सर्वर के आईपी एड्रेस) को इंगित करता है। इसके बाद, एक टीम बनाएं और अपने मैटरमोस् सर्वर से जुड़ने के लिए लोगों को आमंत्रित करें।
...
- अपनी समीक्षा को प्रबंधित करने, अनुरोधों, टिप्पणियों और मर्ज करने के लिए अपने स्लैश कमांड का उपयोग करके अपने Github संगठन को मैटरमोस्ट से कनेक्ट करें। GitHub मैटरमोस्ट में प्री-पैकेज्ड है। [कॉन्फ़िगरेशन स्टेप्स [https://github.com/mattermost/mattermost-plugin-github#configuration]का पालन करें, और फिर अपनी टीम को /github connect चलाना बताए  ताकि वे अधिसूचना प्राप्त कर सकें।
- अपने Jira खाते को मैटरमोस्ट से कनेक्ट करें और बॉट के लिए एक चैनल सेटअप करें ताकि आपकी टीम हमेशा अद्यतित रहे। आरंभ करने के लिए [कॉन्फ़िगरेशन गाइड](https://mattermost.gitbook.io/plugin-jira/setup/configuration) पर जाएँ।  कॉन्फ़िगर करने के बाद, [उपयोगकर्ता डॉक्यूमेंटेशन](https://mattermost.gitbook.io/plugin-jira/end-user-guide/getting-started) को अपनी टीम के साथ साझा करें ताकि वे सूचनाएं प्राप्त कर सकें।
