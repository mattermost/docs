...
3. `Download <https://mattermost.com/apps>`__ the Mattermost apps for desktop and mobile. Refer to the :doc:`Use Mattermost </guides/use-mattermost>` end user documentation on how to get up and running quickly.
