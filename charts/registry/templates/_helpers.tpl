...
*/}}
{{- define "registryHost" -}}
{{- coalesce .Values.ingress.hostname (include "assembleHost"  (dict "name" "registry" "context" . )) -}}
{{- end -}}
...
{{- pluck "secretName" .Values.ingress.tls .Values.global.ingress.tls (dict "secretName" (printf "%s-registry-tls" .Release.Name)) | first -}}
{{- end -}}
