...
*/}}
{{- define "minioHost" -}}
{{- coalesce .Values.ingress.hostname (include "assembleHost"  (dict "name" "minio" "context" . )) -}}
{{- end -}}
...
{{- pluck "secretName" .Values.ingress.tls .Values.global.ingress.tls (dict "secretName" (printf "%s-minio-tls" .Release.Name)) | first -}}
{{- end -}}
